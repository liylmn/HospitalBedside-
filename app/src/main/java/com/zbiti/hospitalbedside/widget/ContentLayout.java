...
/**
 * Created by zzr on 2017/3/22
 */

public class ContentLayout extends AutoFrameLayout {
    View loadingView;
    View errorView;
    View emptyView;
    View contentView;
    ...
    private void initAttrs(Context context, AttributeSet attr) {
        TypedArray typedArray = context.obtainStyledAttributes(attr, R.styleable.ContentLayout);
        loadingLayoutId = typedArray.getResourceId(R.styleable.ContentLayout_cl_loadingLayoutId, RES_NONE);
        errorLayoutId = typedArray.getResourceId(R.styleable.ContentLayout_cl_errorLayoutId, RES_NONE);
        emptyLayoutId = typedArray.getResourceId(R.styleable.ContentLayout_cl_emptyLayoutId, RES_NONE);
        contentLayoutId = typedArray.getResourceId(R.styleable.ContentLayout_cl_contentLayoutId, RES_NONE);
        typedArray.recycle();
    }
    ...
    public ContentLayout loadingView(View loadingView) {
        bindView(loadingView, STATE_LOADING);
        return this;
    }

    public ContentLayout errorView(View errorView) {
        bindView(errorView, STATE_ERROR);
        return this;
    }

    public ContentLayout emptyView(View emptyView) {
        bindView(emptyView, STATE_EMPTY);
        return this;
    }
